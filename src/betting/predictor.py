...
class BettingPredictor:
    ...
    def __init__(self, model_path='models/trained/tuned_v1_20260201_155204/classifier_model.json', feature_order_path='models/trained/tuned_v1_20260201_155204/classifier_feature_names.json'):
        """
